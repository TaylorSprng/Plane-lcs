...
var yidong = function() {
	...
	//暂停事件
var number = 0; //标记是否已经暂停
var zanting = function() {
		if (number == 0) {
			suspenddiv.style.display = "block";
			if (document.removeEventListener) { //兼容
			...
			if (document.addEventListener) {
				...
				bodyobj.addEventListener("mousemove", bianjie, true); //边界事件
...
if (document.addEventListener) {
	...
	//  suspenddiv.getElementsByTagName("button")[1].addEventListener("click",begin,true);
	//为暂停界面的返回主页按钮添加事件
...
var bullets = [];
var mark = 0;
var mark1 = 0; //定义两个变量。控制创建飞速度
var backgroundPositionY = 0; //背景高度初始化
/*
开始函数
 */
function start() {
	...
	for (var i = 0; i < enemyslen; i++) { //飞机没有摧毁则执行移动事件
	...
	*/
	if (mark % 5 == 0) {
		...
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) + 80, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) + 100, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) + 120, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) + 140, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) + 160, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) + 180, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) + 200, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) - 20, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) - 40, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) - 60, parseInt(selfplan.imagenode.style.top) - 10));
		bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left) - 80, parseInt(selfplan.imagenode.style.top) - 10));
